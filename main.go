...
import (
	...
	apiServices "ImageAlbumService/ImageAlbum"
	config "ImageAlbumService/config"
	"ImageAlbumService/database"
...
func main() {
	...
	g.DELETE("/image/album/:imageAlbumName", api.DeleteHandler.DeleteImageAlbumTable)
	g.POST("/image/album", api.PostHandler.CreateImageAlbumTable)
